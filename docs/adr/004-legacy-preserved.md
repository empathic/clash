...
Users migrating from v1 should rewrite their policies in Starlark format. See the [Migration Guide](../migration-guide.md) for side-by-side examples, or the [Policy Writing Guide](../policy-guide.md) for full reference.
